    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Add New Room</h1>
            </div>
            ...
            <div className="bg-white dark:bg-card p-8 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            <label className="flex items-center gap-2 cursor-pointer p-3 border border-gray-200 dark:border-gray-700 rounded-lg has-[:checked]:border-primary has-[:checked]:bg-primary/5">
                                <input type="radio" value="ROOM" {...register('type')} defaultChecked className="text-primary focus:ring-primary" />
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full p-3 rounded-lg bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-primary focus:outline-none"
                                />
                                <p className="mt-1 text-xs text-gray-500">Initial room unit.</p>
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full p-3 rounded-lg bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-primary focus:outline-none"
                                />
                                <p className="mt-1 text-xs text-gray-500">Initial kitchen unit.</p>
                            </div>
                        </div>
                    ) : (
                        <div>
                            ...
                            <input
                                ...
                                className="w-full p-3 rounded-lg bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-primary focus:outline-none"
                            />
                            <p className="mt-1 text-xs text-gray-500">Initial reading for this room.</p>
                        </div>
                    )}
                    ...
                    >
                        {loading ? 'Saving...' : <><Save className="h-5 w-5" /> Save Room</>}
                    </button>
                </form>
            </div>
        </div>
